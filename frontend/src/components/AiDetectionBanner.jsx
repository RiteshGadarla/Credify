...
/**
 * AiDetectionBanner
 * Displays the AI text detection result as a banner above results.
 *
 * Props:
...
const AiDetectionBanner = ({ detection }) => {
  ...
  const bandConfig = {
    human: {
      ...
      sublabel: 'Found no strong indicators of synthetic content.',
    ...
    ai: {
      ...
      sublabel: 'Strongly suspects this text is synthetic or AI-written.',
